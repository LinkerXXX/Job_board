# Generated by Django 4.1.5 on 2023-08-16 11:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=50, verbose_name="Имя резюме")),
                ("skills", models.CharField(max_length=50, verbose_name="Навыки")),
                (
                    "information",
                    models.TextField(
                        max_length=1023, verbose_name="Сопутствующая информация"
                    ),
                ),
